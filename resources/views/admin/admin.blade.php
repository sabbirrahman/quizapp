...
@section('main')
	<div ng-app="quizapp-admin" ng-controller="MainController" class="mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
		<header class="mdl-layout__header">
	  	...
	  	<div class="mdl-layout__drawer">
	    	...
	    	<nav class="mdl-navigation">
	      		...
	      		<a class="mdl-navigation__link" href="#/students"><i class="material-icons">people</i> <span class="text">Students</span></a>
